...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { city: @employer.city, email: @employer.email, name: @employer.name, phone: @employer.phone, website: @employer.website }
    end
  ...
  test "should update employer" do
    put :update, id: @employer, employer: { city: @employer.city, email: @employer.email, name: @employer.name, phone: @employer.phone, website: @employer.website }
    assert_redirected_to employer_path(assigns(:employer))
  end
